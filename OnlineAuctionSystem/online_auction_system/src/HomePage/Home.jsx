...
const Home = ({user}) => {
    ...
    const images = [fashionGirl, earings, girl]; 
    ...
    return (
        <div className="home-container">
            ...
            <Navbar isLoggedIn={user !== null} />
                ...
                <h3 className="txt">Welcome to BidZone...!Login to Bid</h3>
                ...
                <nav>
                    <ul>
                        <li><Link to="/fashion">All</Link></li>
                        <li><Link to="/clothes">Women's Clothes</Link></li>
                        <li><Link to="/Accessories">Fashion Accessories</Link></li>
                        {/* Add more categories */}
                    </ul>
                </nav>
